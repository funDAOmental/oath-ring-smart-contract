...
contract AccessPass is IERC2981, Ownable, ERC721Enumerable {
     ...
     */
    constructor(
        IProxyRegistry openSeaProxyRegistry_,
     ...
     */
    function setContractURIHash(string memory _contractURIHash)
        external
        onlyOwner
    {
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        return (
            royaltyPayout,
            SafeMath.div(SafeMath.mul(salePrice, sellerFeeBasisPoints), 1000)
        );
    }
}
